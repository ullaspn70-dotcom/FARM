          ...
          <div className="passport-body">
            ...
            <div className="passport-verified-banner">
              ...
              <div className="banner-details">
                ...
                <div className="continuous-monitored-tag">
                  ...
                  <span>Continuously Monitored via BioShield Telemetry</span>
                </div>
              </div>
            ...
            <div className="passport-footer">
              <p className="passport-disclaimer">
                <AlertTriangle size={14} className="inline-icon" /> Official Digital Passport generated by BioShield Platform (SIH260487). Tampering or misrepresentation of biosecurity status is punishable under Animal Health Protocols.
              </p>
