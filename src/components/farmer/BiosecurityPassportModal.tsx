          ...
          <div className="passport-body">
            ...
            <div className="passport-footer">
              <p className="passport-disclaimer">
                <AlertTriangle size={14} className="inline-icon" /> Official Digital Passport generated by AgriSentinel Platform (SIH260487). Tampering or misrepresentation of biosecurity status is punishable under Animal Health Protocols.
              </p>
